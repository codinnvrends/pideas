...
def distill_idea(project_idea_raw: str) -> str:
    ...
    You are a Technical Product Manager. Your goal is to convert a user's potentially vague or verbose project idea into a strict Technical Blueprint for a development team.
